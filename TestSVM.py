...
def predictAndPlot(X, y, n_samples, cluster_std, fig_title, svm):
    ...
    p.plotSVM(X, X_test, y, y_test, svm_object, fig_title, y_predicted)
...
svm_object.training(X, y)

# cross validation
samples = 30
clusterStd = 2
figure_title = "Training & Classification"
predictAndPlot(X, y, samples, clusterStd, figure_title, svm_object)
